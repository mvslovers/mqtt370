...
/* mqtc_process_unsuback()
 * Process UNSUBACK from client.
 */

int mqtc_process_unsuback(MQTC *mqtc, CPB *pb)
{
    int             rc      = 0;
    unsigned        len     = 0;
    unsigned        pos     = 0;
    ...
    // mqtc_packet_dump(mqtc, pb, "UNSUBACK");
    ...
    /* discard the retry record for this message id */
